...
xtest('it returns the correct schedule when two orders are placed', () => {
  let shack = new app.SnackShack()
...
xtest('turnSecondsToMinutesAndSeconds when given 90 returns 1:30', () => {
  expect(app.turnSecondsToMinutesAndSeconds(90)).toBe('1:30')
})

xtest('turnsecondstominutesandseconds when given 250 returns 4:10', () => {
  expect(app.turnSecondsToMinutesAndSeconds(250)).toBe('4:10')
})

xtest('turnsecondstominutesandseconds when given 240 returns 4:00', () => {
