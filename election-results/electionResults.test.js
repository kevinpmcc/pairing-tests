...
test('formatResults will return the name of the party', () => {
    ...
    expect(actual).toContain('Labour Party')
    expect(actual).toContain('Conservative Party')
})
...
test('removeWhiteSpaceAtStart removes 1 character of whitespace from the start of a string', () => {
    expect(removeWhiteSpaceAtStart(' L')).toEqual('L')
    expect(removeWhiteSpaceAtStart(' LD')).toEqual('LD')
    expect(removeWhiteSpaceAtStart(' UKIP')).toEqual('UKIP')
})
